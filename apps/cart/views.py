...
from .models import Cart, Item, Favorite, Product
...
class CartListView(LoginRequiredMixin, TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['cart'] = cart
        context['shipping_cost'] = self.request.session.get('shipping_cost', 0)
        return context
...
def calculate_shipping(request):
    if request.method == 'POST':
        ...
        if not zip_code:
            ...
            return render(request, 'salud/shop-cart.html', {'error_message': 'Zip code is required.'})
    ...
    return render(request, 'salud/shop-cart.html')
